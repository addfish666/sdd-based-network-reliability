...
int main(int argc, char** argv) {
  ...
  sdd_vtree_save("output/before-rotate-vtree.dot",manager_vtree);
  sdd_save("output/before-rotate-sdd.dot",alpha);
  ...
  printf("saving vtree & sdd ...\n");
  sdd_vtree_save("output/after-rotate-vtree.dot",manager_vtree);
  sdd_save("output/after-rotate-sdd.dot",alpha);
